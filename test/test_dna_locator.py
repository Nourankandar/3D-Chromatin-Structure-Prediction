...
from backend.services.Genome_reference1.DNA_locator import locate_patient_sequence, SequenceLocationError
import backend.services.Genome_reference1.DNA_locator as dna_locator
